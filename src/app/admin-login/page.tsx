          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="cursor-pointer w-full bg-accent1 text-white py-3 px-4 rounded-lg font-medium hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent1 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {loading ? (
